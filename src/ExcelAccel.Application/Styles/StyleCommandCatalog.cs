...
public static class StyleCommandCatalog
{
    private static readonly IReadOnlyList<CommandDescriptor> Commands = new[]
    {
        ...
        Apply("style.apply", "Apply Local Style", RibbonRoutes.For("style.apply"), "Alt, X, A, Y, L"),
        Apply("style.apply_builtin", "Apply Built-in Style", RibbonRoutes.For("style.apply_builtin"), "Alt, X, A, Y, B"),
