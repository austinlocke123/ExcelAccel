...
public static class RibbonRoutes
{
    private static readonly IReadOnlyDictionary<string, string> Routes = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        { "compare.ranges.same_shape", "Alt, X, A, AC, C" },
        { "compare.result.navigate_target", "Alt, X, A, AC, T" },
        { "compare.results.export", "Alt, X, A, AC, E" },
        { "compare.source.capture", "Alt, X, A, AC, S" },
        ...
        { "links.inventory.export", "Alt, X, A, AL, E" },
        { "links.inventory.open", "Alt, X, A, AL, O" },
        { "links.navigate_usage", "Alt, X, A, AL, G" },
        { "model_check.results.export", "Alt, X, A, AM, E" },
        { "names.inventory.export", "Alt, X, A, AN, E" },
        { "names.inventory.open", "Alt, X, A, AN, O" },
        { "names.navigate_target", "Alt, X, A, AN, G" },
