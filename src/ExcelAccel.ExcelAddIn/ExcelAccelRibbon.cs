...
public sealed class ExcelAccelRibbon : ExcelRibbon
{
              ...
              <tabs>
                <tab id='ExcelAccel.Tab' label='ExcelAccel' keytip='XA'>
                  ...
                  <group id='ExcelAccel.Group.NumberFormat' label='Number Format'>
                    <button id='ExcelAccel.ApplyCurrency' label='Currency' keytip='C' imageMso='AccountingFormat' tag='format.number.currency' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                    <button id='ExcelAccel.General' label='General' keytip='G' tag='format.number.general' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                    <button id='ExcelAccel.Percentage' label='Percentage' keytip='P' tag='format.number.percentage' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                    <button id='ExcelAccel.Date' label='Date' keytip='D' tag='format.number.date' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                    <button id='ExcelAccel.Multiple' label='Multiple' keytip='NM' tag='format.number.multiple' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                    <button id='ExcelAccel.Boolean' label='Boolean' keytip='NB' tag='format.number.boolean' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                  ...
                  <group id='ExcelAccel.Group.CellFormat' label='Cell Format'>
                    ...
                    <menu id='ExcelAccel.Align' label='Align' keytip='EA' imageMso='AlignCenter'>
                      ...
                      <button id='ExcelAccel.VerticalAlignment' label='Cycle Vertical' keytip='V' tag='format.alignment.vertical.cycle' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                    ...
                    <menu id='ExcelAccel.Font' label='Font' keytip='EF' imageMso='FontDialog'>
                      <button id='ExcelAccel.FontSize' label='Cycle Font Size' keytip='S' tag='format.font_size.cycle' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                      <button id='ExcelAccel.Underline' label='Cycle Underline' keytip='U' tag='format.underline.cycle' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                    </menu>
                    ...
                    <menu id='ExcelAccel.Size' label='Size' keytip='ES' imageMso='CellsMenu'>
                      <button id='ExcelAccel.RowHeight' label='Cycle Row Height' keytip='R' tag='format.row_height.cycle' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
                      <button id='ExcelAccel.ColumnWidth' label='Cycle Column Width' keytip='C' tag='format.column_width.cycle' getVisible='OnGetCycleVisible' onAction='OnFormattingCommand'/>
    ...
    /// <summary>
    /// Captures the ribbon so a profile change can invalidate the cycle buttons.
    /// Excel calls this once per session, before any control is queried.
    /// </summary>
    public void OnRibbonLoad(IRibbonUI ribbon) => _ribbon = ribbon;

    /// <summary>
    /// Re-asks Excel for every dynamic property. Called after the profile
    /// changes, because the ribbon caches getVisible results until invalidated.
    /// </summary>
    public static void InvalidateCycleVisibility()
    {
        try { _ribbon?.Invalidate(); }
        catch (Exception exception) { DiagnosticLog.Error("ribbon.invalidate", exception); }
    }

    /// <summary>
    /// Hides a button whose cycle the user deleted. The ribbon XML is static, so
    /// a button cannot remove itself; without this it would remain, refusing by
    /// name on every press.
    /// </summary>
    public bool OnGetCycleVisible(IRibbonControl control)
    {
        try { return CycleVisibility.IsVisible(ProfileRuntime.Current, control?.Tag ?? string.Empty); }
        catch (Exception exception)
        {
            // A control that cannot be evaluated stays visible: an invisible
            // command is harder to diagnose than one that refuses with a reason.
