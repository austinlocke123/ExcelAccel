...
| ADR | Status | Decision |
|---|---|---|
| [ADR-0001](ADR-0001-excel-dna-host.md) | Proposed | Excel-DNA host with a time-bounded contingency trigger |
| [ADR-0002](ADR-0002-runtime.md) | Proposed | Runtime and target-framework recommendation |
